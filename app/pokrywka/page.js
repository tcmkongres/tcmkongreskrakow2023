          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <div className="max-w-xl">
                <p className="mt-6">
                  Medycyna Chińska jest moją pasją, filozofią życia i pracą.
                  Akupunktura jest głównym narzędziem mojej pracy. Od ponad 15
                  lat prowadzę swój gabinet we Wrocławiu. Pomagam kobietom,
                  które cierpią z powodu zaburzeń swojego cyklu miesiączkowego.
                  Wspieram niepłodne pary w odbudowaniu swojego ciała i
                  przygotowaniu się do poczęcia. Dbam o zdrowie i odporność
                  kobiet w ciąży oraz małych dzieci. Prowadzę kursy akupunktury
                  dla terapeutów oraz warsztaty medycyny chińskiej dla swoich
                  pacjentów.
                </p>
              </div>
            </div>
